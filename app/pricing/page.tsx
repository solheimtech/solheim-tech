...
export default function PricingPage() {
  return (
    <div className='text-white p-6 max-w-4xl mx-auto pt-[8rem] lg:pt-[2rem] text-center'>
      <h1 className='text-5xl font-bold mb-4'>Solheim Technologies Pricing</h1>
      <p className='mb-4'>
      ...
      <section className='mb-6'>
        ...
        <ul className='list-disc list-inside mb-4 inline-block text-left'>
      ...
      <CallToAction
    title="Questions?"
    description="What questions can we answer for you?"
