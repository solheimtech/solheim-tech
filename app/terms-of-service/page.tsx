...
const TermsOfServicePage = () => {
  return (
    <div className='text-white p-6 max-w-4xl mx-auto pt-[8rem] lg:pt-[2rem]'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 1 – WEBSITE TERMS</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 2 – GENERAL CONDITIONS</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 3 – ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 4 – MODIFICATIONS TO THE SERVICE AND PRICES</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 6 – ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 10 – PERSONAL INFORMATION</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 11 – ERRORS, INACCURACIES AND OMISSIONS</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 12 – PROHIBITED USES</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 13 – DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
        <p className='mb-4'>
          We do not guarantee, represent or warrant that your use of our service will be uninterrupted, timely, secure or error-free. We do not warrant that the results that may be obtained from the use of the service will be accurate or reliable. You agree that from time to time we may remove the service for indefinite periods of time or cancel the service at any time, without notice to you. You expressly agree that your use of, or inability to use, the service is at your sole risk. The service and all products and services delivered to you through the service are (except as expressly stated by us) provided ‘as is’ and ‘as available’ for your use, without any representation, warranties or conditions of any kind, either express or implied, including all implied warranties or conditions of merchantability, merchantable quality, fitness for a particular purpose, durability, title, and non-infringement. In no case shall Solheim Technologies, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
        </p>
      </section>

      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 14 – INDEMNIFICATION</h2>
        <p className='mb-4'>
          You agree to indemnify, defend and hold harmless Solheim Technologies and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
        </p>
      </section>

      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 15 – SEVERABILITY</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 16 – TERMINATION</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 17 – ENTIRE AGREEMENT</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 18 – GOVERNING LAW</h2>
        <p className='mb-4'>
          These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of Arizona, United States of America.
        </p>
      </section>

      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 19 – CHANGES TO TERMS OF SERVICE</h2>
        <p className='mb-4'>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 20 – CONTACT INFORMATION</h2>
        <p className='mb-4'>
          Questions about the General Terms of Service should be sent to us at <a href='mailto:support@solheimtech.com' className='text-blue-500'>support@solheimtech.com</a>.
        </p>
      </section>
      ...
      <section className='mb-6'>
        <h2 className='text-2xl font-semibold mb-2'>SECTION 1 – MEMBERSHIP PLANS AND PRICING</h2>
        <p className='mb-4'>
