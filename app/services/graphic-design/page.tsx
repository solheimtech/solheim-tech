...
export const metadata = {
  title: "Graphic Design | Solheim Technologies",
  description: "Creative and impactful graphic design solutions for your business.",
  openGraph: {
    title: "Graphic Design | Solheim Technologies",
    description: "Creative and impactful graphic design solutions for your business.",
    url: 'https://solheimtech.com/services/graphic-design',
    images: [
      {
