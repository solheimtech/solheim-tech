...
export default function Meeting() {
  return (
    <div className="container mx-auto py-12">
      <h1 className="text-[2rem] sm:text-[3rem] md:text-[4rem] lg:text-[4rem] font-bold">Technology Consultation</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col items-center justify-center p-6 border border-white rounded-lg shadow-md">
